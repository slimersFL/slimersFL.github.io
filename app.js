...
(function () {
  ...
  const CONFIG = {
    ...
    FORMSPREE_NEWSLETTER: 'https://formspree.io/f/xwvabpzq',
    FORMSPREE_CONTACT:    'https://formspree.io/f/xwvabpzq',
  ...
  const GALLERY_ITEMS = [
    ...
    { caption: 'Slimer @hex_moto: Photo-> @man_the_danalog',   src: 'img/slime3.jpg', sticker: 'SLIMED' },
    { caption: 'Rocky the grilled cheese cowboy @churchills_pub', src: 'img/slime5.jpg', sticker: 'CHEESED' },
    { caption: 'T-Slime: : Photo-> @man_the_danalog',     src: 'img/slime4.jpg', sticker: '' },
    { caption: 'J-SLime @churchills_pub: Photo-> @hi__d',     src: 'img/slime6.jpg', sticker: '' },
